...
public class EmailService {
    ...
    * 링크로 연결
    ...
    private MimeMessage createMessage(String to) throws Exception {
        ...
        message.setSubject("하이카디 신규 소식 알림");

        String msgg = "<div style='max-width: 600px; margin: 0 auto; font-family: Arial, sans-serif;'>";
        msgg += "<h1 style='color: #00428B; text-align: center;'>하이카디 신규 소식 알림</h1>";
        msgg += "<p style='text-align: center;'>하이카디에 대한 새로운 소식입니다.</p>";
        ...
        msgg += "<a href='http://localhost:8082/news' style='font-size: 20px; font-weight: bold;'>하이카디 소식 바로가기</a>";
        msgg += "</div>";
